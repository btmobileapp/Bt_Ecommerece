package biyaniparker.com.parker.view.managestock;
...
public class StockManageProductView extends AppCompatActivity implements View.OnClickListener , DownloadUtility{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_stock);                 //used same resource file again
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(StockManageProductView.this,ViewProductImage.class);
        ...
        else
        {
                ...
                if( validation()) {
                    for (int i = 0; i < viewList.size(); i++) {
                        ...
                        {
                            if(Integer.parseInt(ed.getText().toString())!=0) {
                                if (Integer.parseInt(ed.getText().toString()) < 0) {
                                    s.setSizeId(SizeId);
                                    s.setOutwardQty(-1 * Integer.parseInt(ed.getText().toString()));
                                    stockList.add(s);
                                } else {
                                    s.setSizeId(SizeId);
                    ...
                    if (stockList.isEmpty()) {
                        ...
                        try {
                            moduleProduct.manageProductStock(bean, stockList);
            ...
            for(int j=0; j < viewList.size(); j++)
            {
                ...
                if (temp.getSizeId()==sizeId )
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (temp.getQnty() < -1 * Integer.parseInt(ed.getText().toString())) {
                                return false;
                            }
                        }
                    }
    ...
    public void onComplete(String str, int requestCode, int responseCode)
    {
        ...
        if(requestCode==5 && responseCode==200)
        {
            ...
            alertDialog.setMessage("Stock Updated Succefully");
    ...
    private void renderView()
    {
        ...
        for(int i=0;i<moduleProduct.sizeMasters.size();i++)
        {
           SizeMaster s= moduleProduct.sizeMasters.get(i);
            ...
            final View v= inflater.inflate(R.layout.o_activity_sizes_for_product__arrow, null);
            linear.addView(v);

            final  TextView txtName=(TextView)v.findViewById(R.id.txtSizeName);
            final  TextView txtAvaibleQnty=(TextView)v.findViewById(R.id.txtAvaibleQnt);
            final  EditText edQty=(EditText)v.findViewById(R.id.edSizeQty);
            edQty.setText("0");
            final ImageView imgPlus=(ImageView)v.findViewById(R.id.imgplus) ;
            final ImageView imgMinus=(ImageView)v.findViewById(R.id.imgminus) ;
            imgPlus.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v)
                {
                    int qt=Integer.parseInt(edQty.getText().toString());
                   qt= qt+1;
                    edQty.setText(""+qt);
                }
            });
