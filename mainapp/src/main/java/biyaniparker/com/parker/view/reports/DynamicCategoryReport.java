...
public class DynamicCategoryReport extends AppCompatActivity implements AdapterView.OnItemClickListener, DownloadUtility, View.OnClickListener, NotifyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       arrayList.addAll( moduleCategory.getListByParentId(catId));
        ...
        else if(arrayList.isEmpty())
        {
            ...
            getSupportActionBar().setTitle("Product Stock Report ");
            ...
            moduleReport.getProductStockReportWithNotify(UserUtilities.getClientId(this), catId);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id)
    {
        if(!Pressed)
        {
            ...
            Intent intent = new Intent(this, DynamicCategoryReport.class);
    ...
    public void onClick(View v)
    {
        ...
        {
            collectHashMapList();
            PrintStock printStock=new PrintStock(this,imageLoader,moduleReport.reportDataList,catId,"Stock");
            printStock.setFileNameAndTitle("STOCK REPORT","Stock");
            printStock.call();
