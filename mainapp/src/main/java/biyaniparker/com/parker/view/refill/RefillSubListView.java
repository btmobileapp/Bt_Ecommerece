...
public class RefillSubListView extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.o_activity_refill_list_subcategory);
        ...
        categoryAdapter=new CategoryAdapter(this,1,moduleCategory.getListByParentId(catId));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id)
    {
        ...
        Intent intent=new Intent(this,ProductGridListView.class);
